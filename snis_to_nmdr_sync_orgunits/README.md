...
- `nmdr_connection` (obligatoire): connexion DHIS2 cible
...
- present dans SNIS et absent dans NMDR -> creation
- absent dans SNIS et present dans NMDR -> fermeture (`closedDate`)
